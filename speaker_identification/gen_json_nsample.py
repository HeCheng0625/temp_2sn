...
def options():
    ...
    parser.add_argument("--nsample", type=int, default=10, help="The output json file")
...
if __name__ == "__main__":
    ...
    for fn in os.listdir(ref_dir):
        ...
        test_case = {
            ...
            'synthesized_wav_paths':  [f'{gen_dir}/{gen_prefix}sp{idx}_{fn.replace(".flac", ".wav")}'  for idx in range(nsample)],
            'synthesize_phoneme_seq': [],
            }

...
class FastSpeechDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        elif code.shape[0] < mel2ph.shape[0]:
            mel2ph = mel2ph[:code.shape[0]]

        mel2ph[mel2ph > phone.shape[0]] = 0
        
        f0 = f0[:mel2ph.shape[0]] if (self.hparams['use_pitch_embed'] or self.hparams["apply_pitch_on_x0"]) else None
        uv = uv[:mel2ph.shape[0]] if (self.hparams['use_pitch_embed'] or self.hparams["apply_pitch_on_x0"]) else None
        ...
        mel2ph_res = ret_info["mel2ph_new"] 

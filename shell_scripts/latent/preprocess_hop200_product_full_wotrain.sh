...
python -m datasets.tts.product.gen_fs2_product_full_wotrain --hparams "data_dir=${DATA_DIR},raw_data_dir=${TEXT},full_file=${FULL_FILE},code_data_dir=${CODE_DATA},emb_data_dir=${EMB_DATA},f0_use_product=False" --config configs/tts/product/fs2_discrete_vqemb_hop200res16.yaml
=======

...
python -m usr_dir.tasks.latent_diffusion_pl2 --config configs/tts/product/latent_diffusion_5wdata.yaml --exp_name ${SAVE_DIR} --reset --hparams "data_dir=${DATA_DIR},\
                                            raw_data_dir=${TEXT},max_tokens=8000,detach_mu=${detach_mu},detach_wavenet=${detach_wavenet},\
                                            ...
                                            strategy=ddp,precision=16-mixed,accumulate_grad_batches=1,num_nodes=1,warmup_updates=30000,\
                                            lr=1e-4,max_frames=3000,max_input_tokens=600,use_random_segment_as_ref=True,\
...
# predictor_type=transformer_v1
# transformer_esitimator_arch=${transformer_esitimator_arch}
# dec_ffn_kernel_size=3
# transformer_hidden=512

# check old train shell: /home/v-yuancwang/fast_speech2/shell_scripts/latent/deepspeed/fs2diffusion_11lab.sh
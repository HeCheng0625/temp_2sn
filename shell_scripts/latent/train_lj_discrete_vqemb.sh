...
DATA_DIR=/blob/v-shenkai/code/tts/fs2_fromyc/mm_lm_nat/data-bin/ljspeech_discrete_res8_vqemb
SAVE_DIR=/blob/v-shenkai/code/tts/fs2_fromyc/mm_lm_nat/checkpoints/ljspeech_discrete_res8_vqemb_1

mkdir -p ${SAVE_DIR}
export CUDA_VISIBLE_DEVICES=0
python -m tasks.fs2_discrete_vqemb --config configs/tts/lj/fs2_discrete_vqemb.yaml --exp_name ${SAVE_DIR} --reset --hparams "data_dir=${DATA_DIR},raw_data_dir=${TEXT},max_tokens=14000"

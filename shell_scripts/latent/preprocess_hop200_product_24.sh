...
python -m datasets.tts.product.gen_fs2_discrete_vqemb_hop200res16 --hparams "data_dir=${DATA_DIR},raw_data_dir=${TEXT},vq_ckpt=${VQ_CKPT},train_file=${TRAIN_FILE},valid_file=${VALID_FILE},test_file=${TEST_FILE},code_data_dir=${CODE_DATA},emb_data_dir=${EMB_DATA}" --config configs/tts/product/fs2_discrete_vqemb_hop200res16.yaml

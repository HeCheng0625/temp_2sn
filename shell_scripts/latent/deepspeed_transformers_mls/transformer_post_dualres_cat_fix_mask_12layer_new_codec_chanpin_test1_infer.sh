...
SAVE_DIR=/blob/v-yuancwang/LATENT_TTS/transformer_post_dualres_cat_fix_mask_12layer_new_codec_spk_prompt_false
...
gen_dir_name=transformer_post_dualres_cat_fix_mask_12layer_new_codec_10wsteps

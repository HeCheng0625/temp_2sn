...
# A big version: 20 layers; hidden_size=768; num_head=12 
...
SAVE_DIR=/blob/v-yuancwang/ns2/checkpoints/transformers/conformer_post_dualres_cat_fix_mask_new_codec_spk_prompt_false_drop0_1
# /bin/rm -rf ${SAVE_DIR}
...
python -m usr_dir.tasks.latent_diffusion_pl2 --config configs/tts/product/latent_diffusion_5wdata.yaml --exp_name ${SAVE_DIR} --reset --hparams "data_dir=${DATA_DIR},\
                                            ...
                                            predictor_type=conformer_post_dualres_cat,diffusin_dropout=${diffusin_dropout},\

...
python -m usr_dir.tasks.latent_diffusion_pl2 --config configs/tts/product/latent_diffusion_5wdata.yaml --exp_name ${SAVE_DIR} --reset --hparams "data_dir=${DATA_DIR},\
                                            raw_data_dir=${TEXT},max_tokens=3200,detach_mu=${detach_mu},detach_wavenet=${detach_wavenet},\
                                            ...
                                            strategy=ddp,precision=16-mixed,accumulate_grad_batches=6,num_nodes=1,warmup_updates=30000,\

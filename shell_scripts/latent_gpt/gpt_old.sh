...
python -m usr_dir.tasks.uni_speech_gpt --config configs/tts/lj/fs2_latent_gpt.yaml --exp_name ${SAVE_DIR} --reset --hparams "data_dir=${DATA_DIR},raw_data_dir=${TEXT},max_tokens=4000,log_interval=1,\
